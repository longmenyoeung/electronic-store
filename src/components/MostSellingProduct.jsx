...
function MostSellingProduct() {
    ...
    <div className='w-full mb-5 lg:mt-24'>
        <div className="container px-4 lg:px-[128px] mx-auto">
            <h1 className='text-3xl font-bold mb-5'>Most Selling Products</h1>
                                ...
                                <div key={i} className='w-[49%] md:w-[32%] shrink-0' data-aos="fade-down">
                                    ...
                                    <div className='py-5 flex justify-between'>
                                        <div>
                                            ...
                                            <button className='border px-5 py-3 rounded-3xl cursor-pointer hover:bg-orange-600 hover:text-white duration-300 mt-3'>
                                                Add Cart
                                            </button>
                                        </div>
                                        <div>
